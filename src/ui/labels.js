...
/** Primary RESULT_ACTIONS row (under result grid) — no loud 「更多」 */
export const RESULT_PRIMARY_ACTIONS = Object.freeze(['下载', '加入画布', '当参考图'])

/** Quiet overflow (···) — 重新生成 secondary here; keep unwired honest in host */
