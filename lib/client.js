...
var css = {
  ...
  topTab: (on) => `padding:1px 6px;border:0;background:${on ? T.active : "transparent"};color:${on ? T.fg : T.fg3};cursor:pointer;border-radius:4px;font:inherit;font-size:10.5px;font-weight:${on ? 500 : 400};line-height:1.2;`
};
var HOST_STYLES = `
