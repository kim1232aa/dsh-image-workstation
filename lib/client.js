...
var css = {
  ...
  topTab: (on) => `padding:2px 7px;border:0;background:${on ? T.active : "transparent"};color:${on ? T.fg : T.fg3};cursor:pointer;border-radius:5px;font:inherit;font-size:11px;font-weight:${on ? 500 : 400};line-height:1.2;`
};
var HOST_STYLES = `
