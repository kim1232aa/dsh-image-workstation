...
// src/ui/labels.js
var TOP_TABS, COLUMNS, MODE_TABS, RATIOS, CLARITY, COUNTS, PARAM_LABELS, PROMPT_FIELDS, PROMPT_ACTIONS, CTA, COMPARE, SKILL_ENTRIES, PORTRAIT_SUB, HISTORY_ACTIONS, RESULT_ACTIONS, RESULT_PRIMARY_ACTIONS, RESULT_MORE_ACTIONS, EMPTY, CHROME, VIDEO_MODE_TABS, VIDEO_FRAMES, VIDEO_REFS, VIDEO_PARAMS, VIDEO_CLARITY_TIERS, VIDEO_CTA, VIDEO_RESULT_ACTIONS, VIDEO_CROSS, CANVAS_NODES, CANVAS_NODE_TOOLS, CANVAS_CHROME, GALLERY_VIEWS, GALLERY_SORT, GALLERY_FILTERS, GALLERY_TAG_ACTIONS, GALLERY_ACTIONS, ECOM_UPLOAD, ECOM_FORM, ECOM_PURPOSES, ECOM_FLOW, ECOM_RESULT_ACTIONS, GIF_TITLE, GIF_PARAMS, GIF_FRAME_ACTIONS, GIF_ACTIONS, GIF_CTA, UI_DESIGN_TITLE, UI_DESIGN_STEPS, UI_DESIGN_LABELS, TEMPLATE_TITLE, TEMPLATE_LABELS, TOOL_MORE, TOOL_MENU, TOOL_ENTRIES;
...
var ADD_NODE_HINT = "\u53CC\u51FB\u7A7A\u767D\u6216\u70B9\u300C\u6DFB\u52A0\u300D\u5EFA\u8282\u70B9\uFF1B\u9009\u914D\u7F6E\u540E\u5E95\u90E8\u53D1\u9001\u771F\u51FA\u56FE";
...
<div data-ws-page="canvas" role="region" aria-label="${CANVAS_PAGE}">
  ...
  <div data-ws-canvas-generator ${state.generatorOpen ? "data-open" : ""} aria-label="\u5E95\u90E8\u751F\u6210\u5668">
    ...
    <div>
      ...
      <textarea data-ws-canvas-gen-prompt rows="2" placeholder="\u5199\u63D0\u793A\u8BCD\u6216\u8FDE\u6587\u672C\u8282\u70B9\u540E\u70B9\u53D1\u9001" style="width:100%;min-height:52px;padding:6px 8px;border:1px solid ${T2.border2};border-radius:8px;background:${T2.input};color:${T2.fg};font:inherit;font-size:12px;"></textarea>
    </div>
    ...
    <p data-ws-canvas-status class="note">\u62D6\u8282\u70B9 \xB7 \u7AEF\u53E3\u8FDE\u7EBF \xB7 ${CANVAS_CHROME.send} \u2192 \u771F /dsh-ws/generate\uFF08\u5931\u8D25\u5982\u5B9E\u62A5\u9519\uFF09</p>
  </div>
</div>
`;
}
    ...
    nodesEl.innerHTML = state.nodes.map((n) => {
      ...
      if (n.type === "text") {
        ...
        if (src) {
          ...
          body = `<div data-ws-canvas-img-stub>${escapeHtml2(err.slice(0, 120))}</div>`;
        } else {
